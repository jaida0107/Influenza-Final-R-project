...
## This project analyzes the influenza seasins ikn New York during 2009-2021. Through data summarization with methods such as t-tests and boxplots, we anaylze the past and future influenza seasons. Then using the prophet packagem we can make predictions about the infleunza season for the next 2 years.
...
You can also embed plots, for example: // remove this
...
## Utilizing Advanced R package: Prophet
```{r}
library(ggplot2)
library(dplyr)
library(magrittr)
